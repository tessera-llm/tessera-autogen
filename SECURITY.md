...
If you find a vulnerability in `tessera-autogen` or in the way it interacts with the Tessera proxy, please report it privately.
...
- AutoGen core itself -- report there first; we will fast-follow.

## What to include

A clean reproduction is the fastest path to a fix. Please include:

1. Package version (`pip show tessera-autogen`).
2. AutoGen version.
