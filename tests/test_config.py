"""Unit tests for tessera_autogen._config — pure-function shape verification.

E2E client-construction tests live in test_e2e.py and require autogen-ext
installed (skipped when import fails). This file tests the config dicts
only, so it runs without autogen deps.
"""
...
class TestTesseraOpenAIConfig:
    ...
    def test_headers_carry_tessera_key(self) -> None:
        ...
        assert cfg["default_headers"]["x-tessera-api-key"] == "tk_test_key_abc"
...
class TestTesseraAnthropicConfig:
    ...
    def test_headers_carry_tessera_key(self) -> None:
        ...
        assert cfg["default_headers"]["x-tessera-api-key"] == "tk_test_anth"
...
class TestTesseraConfigDispatcher:
    ...
    def test_forwards_extra_headers(self) -> None:
        ...
        assert cfg["default_headers"]["x-feature-tag"] == "research"
